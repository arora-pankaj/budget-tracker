  ...
  return (
      <aside
        ...
        <div className="px-6 pt-6 pb-0 sticky top-0 bg-black z-20">
          <Link href="/">
            <div
                className="bg-dark-accent-1 hover:bg-dark-accent-2 transition-all rounded-2xl h-12 w-12 flex justify-center items-center">
          ...
          <form className="py-8 flex space-x-4" action="#">
            <div className="flex-1 min-w-0">
              ...
              <div
                  className="relative shadow-sm border-0 border-b-dark-accent-2 rounded-none border-b-[1px] ">
                <div
                    className="absolute bg-black inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
          ...
          {debouncedQuery.length === 0 ? (
              results.map(({_id: letter, users}) => (
                  <div key={letter} className="relative">
                    <div
                        className="bg-dark-accent-1 px-6 py-1 text-sm font-bold text-white uppercase">
                      <h3>{letter}</h3>
                    </div>
